package com.vivospice.contentproviderexample

import android.Manifest.permission.READ_CONTACTS  //like a static import in java
...
//            if (readGranted) {
            if (ContextCompat.checkSelfPermission(this, READ_CONTACTS) == PackageManager.PERMISSION_GRANTED) {
                ...
                val cursor = contentResolver.query(
                    ...
                    projection,
                    null,  //like where clause
                    null, //array of values as place holders. Filters
                ...
                Snackbar.make(view, "Please allow permissions to contacts", Snackbar.LENGTH_INDEFINITE)
                    .setAction("Grant Access") {
                        ...
                        if (ActivityCompat.shouldShowRequestPermissionRationale(this, READ_CONTACTS)) {
                            ...
                            // The user has permanenetly denied the permissions so taking them to the settings
                            Log.d(TAG, "Snackbar onClick: launching settings for app")
                            val intent = Intent()
